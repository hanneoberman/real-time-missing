...
- The prediction model is a flexible regression model (including non-linear effects using RCS with 4 knots and interaction terms). We also store the means and covariance of all predictor variables (which can be used to generate imputations).
