...
# logistic model
mod_true <- fit_true(dat)

# pattern mixture models
mod_sub_6 <- fit_sub(dat, Y ~ X1 + X2 + X3 + X4 + X5 + X6) 
mod_sub_4 <- fit_sub(dat, Y ~ X1 + X2 + X3 + X4) 
mod_sub_2 <- fit_sub(dat, Y ~ X1 + X2) 

# random forest models
mod_rf_imp <- fit_rf_imp(dat)
