...
ggplot(ref_long, aes(y = name, fill = method)) + 
  geom_bar()
...
```{r calibration}
plot_perf(perf, "Intercept") + list(geom_vline(xintercept = 0, color = "grey", linewidth = 2))
plot_perf(perf, "Slope") + list(geom_vline(xintercept = 1, color = "grey", linewidth = 2))
```
